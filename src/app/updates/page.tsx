...
export default function UpdatesPage() {
  ...
  const updates = getBlogPostsByCategory(BlogCategory.UPDATES);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <section className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 font-jameel text-palestine-green">اپ ڈیٹس</h1>
        ...
        <section>
          ...
          {updates.length === 0 && (
            <div className="text-center py-12">
              <p className="text-lg text-gray-700 font-jameel">اس زمرے میں ابھی تک کوئی اپ ڈیٹس نہیں ہیں۔ براہ کرم بعد میں دیکھیں۔</p>
            </div>
          )}
        </section>
      </main>
